...
<div class="data-pegawai-form">
    ...
    <?= $form->field($model, 'kode_terminal')->dropDownList(ArrayHelper::map(Terminal::find()->where(['unit_kerja'=>$unit])->all(), 'kode', 'kode'), ['class'=>'form-control select2']) ?>
    ...
    <?= $form->field($model, 'unit_kerja')->hiddenInput(['value' => $unit])->label(false) ?>
    ...
    <?= $form->field($model, 'kode_tpp')->hiddenInput(['value' => '00'])->label(false) ?>
