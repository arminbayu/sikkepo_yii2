	...
	<div class="row">
		...
		<div class="col-md-12">
			<p style="margin-bottom: 20px">
				<?= Html::a('<i class="fa fa-arrow-left"></i> Kembali', ['data-pegawai'], ['class' => 'btn-sm btn-success']) ?>
			</p>
			...
			<p>
				<?= Html::a('<i class="fa fa-pencil"></i> Edit', ['edit-pegawai', 'nip' => $model->NIP], ['class' => 'btn btn-primary']) ?>
				<!--
				<?= Html::a('<i class="fa fa-trash"></i> Delete', ['delete-pegawai', 'nip' => $model->NIP], [
