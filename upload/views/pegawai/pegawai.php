		...
		<div class="col-md-12">
			<table class="table table-striped">
				...
				<tr>
					...
					<?= Html::a(($data->status == 1) ? '<i class="fa fa-pencil"></i> Set Status' : '<i class="fa fa-pencil"></i> Set Status', ['update-status', 'nip'=>$data->NIP, 'nama'=>$nama], ['class' => ($data->status == 1) ? 'btn-sm btn-success' : 'btn-sm btn-danger',
							'data' => [
