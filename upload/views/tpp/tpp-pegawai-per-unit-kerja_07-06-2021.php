        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><?= ($date <= TANGGAL) ? $form->field($data, "[$index]bobot_kinerja")->textInput(['style' => 'width:60px; height:10px; margin-bottom:-10px; text-align:center'])->label(false) : $data->bobot_kinerja ?></td>
