    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-bordered">
                <tr>
                    <th style="text-align: center; vertical-align: middle; width: 40px; padding-top: 6px; padding-bottom: 6px;">NO</th>
                    <th style="text-align: center; vertical-align: middle; width: 150px;">NIP</th>
                    ...
                    <th style="vertical-align: middle; text-align: center; width: 70px;">TOTAL</th>
                    <!--
                    <th style="vertical-align: middle; text-align: center;">TPP</th>
                    -->
                    <th style="vertical-align: middle; text-align: center; width: 120px" colspan="2">TPP DIBAYAR</th>
                ...
                <tr>
                    <td style="text-align: right; padding-right: 8px; padding-top: 6px; padding-bottom: 6px"><?= $i ?>.</td>
                    <td style="padding-left: 8px"><?= $data->NIP ?></td>
                    <td style="padding-left: 8px; padding-right: 8px"><?= $data->nip->nama ?></td>
                    <!--
                    ...
                    -->
                    <td style="padding-left: 8px; border-right: 0">Rp</td><td style="text-align: right; padding-right: 8px; border-left: 0"><?= ($data->nip->kodeTpp) ? Yii::$app->formatter->asDecimal((($data->bobot_ketepatan + $data->bobot_kehadiran + $bobot_kinerja)/100) * $data->nip->kodeTpp->tpp) : '0' ?>,-</td>
                    <td></td>
                </tr>
                <?php $i++; ?>
                <?php endforeach; ?>
