        ...
        <div class="col-md-12 page-break">
            ...
            <table class="table table-bordered" style="font-size: 0.8em">
                <tr>
                    ...
                    <th style="vertical-align: middle; text-align: center; width: 94px;" colspan="2">JUMLAH<br />TPP</th>
                ...
                <?php
                    ...
                    $tpp_dibayar = $tpp_sebelum_pajak - $pajak;
                ?>
                <tr>
                    ...
                    <td style="padding-left: 8px; border-right: 0;">Rp</td><td style="text-align: right; padding-right: 8px; border-left: 0;"><?= Yii::$app->formatter->asDecimal($pajak) ?></td>
                ...
                <?php endforeach; ?>
                <tr>
                    <th colspan="9" style="text-align: middle; padding-left: 8px">TOTAL</th>
