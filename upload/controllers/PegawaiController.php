...
class PegawaiController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['data-pegawai-api'],
                        'allow' => true,
                    ],
                    [
                        'actions' => ['data-pegawai', 'cari-pegawai', 'pegawai', 'data-pegawai-per-unit-kerja', 'tambah-pegawai', 'edit-kode-terminal', 'edit-no-absen', 'edit-tpp', 'edit-pegawai', 'detail-pegawai', 'update-status'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionDataPegawaiApi($unit)
    {
        $model = DataPegawai::find()
