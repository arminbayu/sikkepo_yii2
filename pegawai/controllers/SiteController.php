...
use common\models\StaffLoginForm;
use common\models\StaffUser;
use pegawai\models\PasswordResetRequestForm;
use pegawai\models\ResetPasswordForm;
use pegawai\models\SignupForm;
use pegawai\models\ContactForm;
...
class SiteController extends Controller
{
    ...
    {
        return $this->redirect(['pegawai/profile']);
    }
    ...
    public function actionLogin()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->login()) {
            // return $this->goBack();
            return $this->redirect(['pegawai/tpp']);
        } else {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($user = $model->signup()) {
                if (Yii::$app->getUser()->login($user)) {
                    return $this->goHome();
                    //return $this->redirect(['participant/seminar']);
                }
            }
        }
