...
<div class="poll" style="width:<?php echo $params['maxLineWidth']+55; ?>px;">
    <?= '<div style="max-width:' . $params['maxLineWidth'].'px; word-wrap: break-word; margin-bottom: 10px; font-size:12pt; font-weight:bold;">' . $pollData['poll_name'] . '</div>'; ?>
    <?php $pullName = (isset($_POST['nameOfPoll']) ? $_POST['nameOfPoll'] : ''); ?>
    <?php
    if ((Yii::$app->user->getId() == null && $_POST['pollStatus'] != 'show' && $isVote == false) || ($pullName == $pollData['poll_name'] && $_POST['pollStatus'] == 'vote' && $_POST['pollStatus'] != 'show' && Yii::$app->user->getId() == null)) {
