...
?>
<div style="background-color: #ccc; width: 100%; height: 100%; background: url(custom/img/sikkepoadmin.jpg); background-size: 100% 100%">
	...
	<div style="background-color: rgba(18, 74, 122, 0.7); left: 25%; right: 25%; width: 50%; height: 55%; top: 20%; position: fixed; padding: 20px">
		<div style="background-color: transparent; display: block; text-align: center; margin-bottom: 20px"><img src="custom/img/logopb.png" width="100" /></div>
