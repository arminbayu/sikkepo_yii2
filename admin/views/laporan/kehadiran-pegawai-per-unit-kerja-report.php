        ...
        <div class="col-md-12 page-break">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><?= $data->tidak_absen_masuk ?></td>
                    <td style="text-align: center;"><?= $data->tidak_absen_siang ?></td>
                    <td style="text-align: center;"><?= $data->tidak_absen_pulang ?></td>
                </tr>
                <?php $i++; ?>
                <?php endforeach; ?>
            </table>
