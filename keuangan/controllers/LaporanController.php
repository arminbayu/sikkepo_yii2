...
class LaporanController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['tpp-per-pegawai', 'tpp-pegawai', 'detail-tpp-pegawai', 'tpp-per-unit-kerja', 'tpp-pegawai-per-unit-kerja', 'tpp-pajak-per-unit-kerja', 'tpp-pajak-pegawai-per-unit-kerja', 'print-tpp-pegawai-pdf', 'print-tpp-pegawai-xls', 'print-tpp-pegawai-per-unit-kerja-pdf', 'print-tpp-pegawai-per-unit-kerja-xls', 'print-tpp-pajak-pegawai-per-unit-kerja-pdf', 'print-tpp-pajak-pegawai-per-unit-kerja-xls'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionPrintTppPegawaiXls($nip, $ym)
    {
        $model = AbsenPegawai::find()
            ->where(['NIP'=>$nip, 'DATE_FORMAT(tanggal, "%Y-%m")'=>$ym])
            ->all();
        ...
        $filename = 'TPP-PER-PEGAWAI-'.$nip.'-'.$ym.'.xls';
        header("Content-type: application/vnd-ms-excel");
        header("Content-Disposition: attachment; filename=".$filename);

        return $this->renderPartial('detail-tpp-pegawai-report-xls', [
            'model'=>$model,
            'pegawai'=>$data,
            'bulan'=>$ym,
            'unit'=>$unit,
    ...
    public function actionPrintTppPegawaiPerUnitKerjaXls($unit, $ym)
    {
        $model = PrestasiPerilakuKerja::find()
            ->where(['unit_kerja'=>$unit])
            // ->andWhere(['status'=>1])
        ...
        $filename = 'TPP-PEGAWAI-'.$unit->nama.'-'.$ym.'.xls';
        header("Content-type: application/vnd-ms-excel");
        header("Content-Disposition: attachment; filename=".$filename);

        return $this->renderPartial('tpp-pegawai-per-unit-kerja-report-xls', [
            'model'=>$model,
            'bulan'=>$ym,
            'unit'=>$unit,
        ]);    
    ...
    public function actionPrintTppPajakPegawaiPerUnitKerjaXls($unit, $ym)
    {
        $model = PrestasiPerilakuKerja::find()
            ->where(['unit_kerja'=>$unit])
            // ->andWhere(['status'=>1])
        ...
        return $this->renderPartial('tpp-pajak-pegawai-per-unit-kerja-report-xls', [
            'model'=>$model,
            'bulan'=>$ym,
            'unit'=>$unit,
        ]);    
    ...
    public function actionPrintXls($ym)
    {
    ...
    public function actionXls($nip, $ym)
    {
        $current_month = date('m', strtotime($ym));
        $current_year = date('Y', strtotime($ym));
