    ...
    <div class="header">
      <div class="header-content">
        <div class="navbar-brand">
          <img style="height: 50px; width: 40px" src="custom/img/lambang.png" />
        </div>
        <span style="font-size: 3em; color: #fff">SIKKEPO</span><span style="font-size: 1.5em; color: #fff; margin-left: 8px">BKD PROVINSI PAPUA BARAT</span>
        <div id="nav-logout">
