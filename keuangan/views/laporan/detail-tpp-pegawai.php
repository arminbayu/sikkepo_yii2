...
<section style="padding-top: 30px; min-height: 600px">
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 20px"><h3>Detail TPP Bulan <?= $monthList[$current_month] ?> Tahun <?= $current_year ?>
        <?= Html::a('<i class="fa fa-file-excel-o"></i> XLS', ['print-tpp-pegawai-xls', 'nip'=>$pegawai->NIP, 'ym'=>$bulan], ['class' => 'btn-sm btn-primary pull-right', 'style' => 'margin-left: 10px', 'target' => '_blank', 'title'=>'Laporan dalam format XLS']) ?>
        <?= Html::a('<i class="fa fa-print"></i> PDF', ['print-tpp-pegawai-pdf', 'nip'=>$pegawai->NIP, 'ym'=>$bulan], ['class' => 'btn-sm btn-primary pull-right', 'target' => '_blank', 'title'=>'Laporan dalam format PDF']) ?>
        </h3></div>
