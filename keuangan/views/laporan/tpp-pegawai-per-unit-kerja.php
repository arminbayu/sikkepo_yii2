...
<section style="padding-top: 30px; min-height: 600px">
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 20px"><h3>
            TPP Pegawai 
            <?= Html::a('<i class="fa fa-file-excel-o"></i> XLS', ['print-tpp-pegawai-per-unit-kerja-xls', 'unit'=>$unit->kode, 'ym'=>$bulan], ['class' => 'btn-sm btn-primary pull-right', 'style' => 'margin-left: 10px', 'target' => '_blank', 'title'=>'Laporan dalam format XLS']) ?>
            <?= Html::a('<i class="fa fa-print"></i> PDF', ['print-tpp-pegawai-per-unit-kerja-pdf', 'unit'=>$unit->kode, 'ym'=>$bulan], ['class' => 'btn-sm btn-primary pull-right', 'target' => '_blank', 'title'=>'Laporan dalam format PDF']) ?>
        </h3></div>
        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <th style="vertical-align: middle; text-align: center;">TPP KOTOR</th>
                </tr>
                <?php $i = 1; ?>
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><?= ($data->nip->kodeTpp) ? Yii::$app->formatter->asDecimal(round($data->nip->kodeTpp->tpp)) : 'Not set' ?></td>
                    <td style="text-align: center;"><?= ($data->nip->kodeTpp) ? Yii::$app->formatter->asDecimal(round((($data->bobot_ketepatan + $data->bobot_kehadiran + $bobot_kinerja)/100) * $data->nip->kodeTpp->tpp)) : '' ?></td>
                </tr>
                <?php $i++; ?>
                <?php endforeach; ?>
            </table>
