        ...
        <ul id="mainmenu-group" class="nav navbar-nav">
          ...
          <li class="rootmenu dropdown">
            ...
            <ul id="menu-administrator" class="dropdown-menu" role="menu">
              <li class="col-xs-12">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-users"></i></div><div class="menu-text">Kelola Admin Unitt</div></div>', ['site/ka-unit']) ?>
              </li>
              <li class="col-xs-12">
              ...
              <li class="col-xs-12">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-gear"></i></div><div class="menu-text">Konfigurasi Mobile</div></div>', ['site/config']) ?>
              </li>
              <li class="col-xs-12">
              ...
              <li class="col-xs-12">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-file"></i></div><div class="menu-text">File Data Absen</div></div>', ['site/file-data-absen']) ?>
              </li>
              <li class="col-xs-12">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-file"></i></div><div class="menu-text">Data Absen Mobile</div></div>', ['site/unit-kerja']) ?>
              </li>
            </ul>
          </li>-->
          <li class="rootmenu dropdown">
          ...
          <li class="rootmenu dropdown">
            ...
            <ul id="menu-kehadiran" class="dropdown-menu" role="menu">
              ...
              <li class="col-xs-6 first">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-pencil"></i></div><div class="menu-text">Entri Upacara</div></div>', ['kehadiran/edit-upacara']) ?>
              </li>
              <!--
              <li class="col-xs-6 first">
              ...
              <li class="col-xs-6">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-pencil"></i></div><div class="menu-text">Entri Ketidakhadiran</div></div>', ['kehadiran/edit-ketidakhadiran']) ?>
              </li>
              <li class="col-xs-6">
              ...
              <li class="col-xs-6">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-pencil"></i></div><div class="menu-text">Entri Tugas Luar</div></div>', ['kehadiran/edit-tugas-luar']) ?>
              </li>
              <li class="col-xs-6">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-file-o"></i></div><div class="menu-text">Absen Manual</div></div>', ['kehadiran/absen-manual']) ?>
              </li>
              <li class="col-xs-6">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-pencil"></i></div><div class="menu-text">Entri Absen Manual</div></div>', ['kehadiran/edit-absen-manual']) ?>
              </li>
              <li class="col-xs-6">
              ...
              <li class="col-xs-6">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-pencil"></i></div><div class="menu-text">Entri Jadwal WFH</div></div>', ['kehadiran/edit-jadwal-wfh']) ?>
              </li>
            </ul>
          </li>
          <li class="rootmenu dropdown">
        ...
        -->
          <li class="rootmenu dropdown">
            ...
            <ul id="menu-laporan" class="dropdown-menu" role="menu">  
              ...
              <li class="col-xs-12">
                <?= Html::a('<div class="clearfix"><div class="menu-icon"><i class="fa fa-file-text"></i></div><div class="menu-text">Rekap Laporan TPP Per Tahun</div></div>', ['laporan/tpp-tahunan-per-unit-kerja']) ?>
              </li>-->
            </ul>
          </li>
        </ul>
