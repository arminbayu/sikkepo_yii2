...
<section style="padding-top: 30px; min-height: 600px">
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 20px"><h3>Kehadiran Pegawai Bulan <?= $monthList[$current_month] ?> Tahun <?= $current_year ?> <?= Html::a('<i class="fa fa-print"></i> PDF', ['print-kehadiran-pegawai-pdf', 'nip'=>$pegawai->NIP, 'ym'=>$bulan], ['class' => 'btn-sm btn-primary pull-right', 'target' => '_blank', 'title'=>'Laporan dalam format PDF']) ?></h3></div>
        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <th style="text-align: center;">Status Absen Masuk</th>
                    <th style="text-align: center;">Status Absen Siang</th>
                    <th style="text-align: center;">Status Absen Pulang</th>
