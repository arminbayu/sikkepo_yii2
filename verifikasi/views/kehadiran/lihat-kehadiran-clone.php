...
//   $current_month = Yii::$app->request->post('month');
//   $current_year = Yii::$app->request->post('year');
// }
// else {
...
<section style="padding-top: 30px; min-height: 600px">
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 20px"><h3>Kehadiran <?= $monthList[$current_month] ?> <?= $current_year ?> <?= $now ?></h3></div>
