...
class LaporanController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['kehadiran-per-pegawai', 'kehadiran-pegawai', 'lihat-kehadiran', 'kehadiran-per-unit-kerja', 'kehadiran-pegawai-per-unit-kerja', 'tpp-per-pegawai', 'tpp-pegawai', 'detail-tpp-pegawai', 'tpp-per-unit-kerja', 'tpp-pegawai-per-unit-kerja', 'print-kehadiran-pegawai-pdf', 'print-kehadiran-pegawai-per-unit-kerja-pdf', 'print-tpp-pegawai-pdf', 'print-tpp-pegawai-per-unit-kerja-pdf'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionTppPegawaiPerUnitKerja($unit)
    {
        ...
        $model = PrestasiPerilakuKerja::find()
            ...
            ->innerJoinWith(['nip'])
            ->orderBy(['(bobot_ketepatan + bobot_kehadiran)' => SORT_DESC])
            ->all();
