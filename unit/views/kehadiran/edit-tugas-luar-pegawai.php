			...
			<?php if ($model) : ?>
				...
				<table class="table table-hover">
					...
					<tr>
						...
						<td style="vertical-align: middle;"><?= $model->dari_jam ?></td>
						<td style="vertical-align: middle;"><?= $model->sampai_jam ?></td>
						<td style="vertical-align: middle;">
							<?= Html::a('<i class="fa fa-trash"></i> Delete', ['delete-tugas-luar', 'id'=>$model->id], [
