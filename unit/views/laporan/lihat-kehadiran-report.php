        ...
        <div class="col-md-12">
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <th style="text-align: center; width: 90px">MASUK</th>
                    <th style="text-align: center; width: 90px">ABSEN<br>SIANG</th>
                    <th style="text-align: center; width: 90px">KELUAR</th>
                    <th style="text-align: center; width: 80px">STATUS MASUK</th>
                    <th style="text-align: center; width: 110px">STATUS<br>ABSEN SIANG</th>
                    <th style="text-align: center; width: 80px">STATUS KELUAR</th>
                    <th style="text-align: center; width: 74px">STATUS</th>
