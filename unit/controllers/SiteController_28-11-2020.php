        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['logout', 'index', 'pengguna', 'reset-password', 'tambah-pengguna', 'edit-pengguna', 'hapus-pengguna', 'terminal', 'tambah-terminal', 'edit-terminal', 'daftar-terminal', 'export-data-absen', 'export-data', 'upload-data', 'upload-data-absen', 'ambil-data', 'data-absen', 'no-absen', 'cari-data-absen', 'pegawai', 'data-absen-pegawai'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
