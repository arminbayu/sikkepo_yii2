 ...
 */
class AbsenPegawaiClone extends \yii\db\ActiveRecord
{
    public $hadir, $tidak_hadir, $datang_terlambat, $tidak_absen_siang, $pulang_cepat, $hari_kerja;
    /**
     * @inheritdoc
     */
    public static function tableName()
    {
        return 'absen_pegawai_clone';
    }
